...
const [heartActive, setheartActive] = useState(0);
    return (<>
        <div className="House ">
            ...
            <div className="heart" id={heartActive && "active"} onClick={()=>setheartActive(!heartActive)}><i className="fa-solid fa-heart"></i></div>
             <div className="rates"><i className="fa-solid fa-star"></i>{rates}</div>
